...
/**
 * Test for /events/findByUser/{id}
 */
Test('/events/findByUser/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test events_getByUser get operation', function (t) {
            Mockgen().requests({
                path: '/events/findByUser/{id}',
                operation: 'get'
            }, function (err, mock) {
                var request;
                t.error(err);
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/events/findByUser/{id}']['get']['responses']['200']['schema']);
