...
/**
 * Test for /events/findByKeyword/{keyword}
 */
Test('/events/findByKeyword/{keyword}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test events_getByKeyword get operation', function (t) {
            Mockgen().requests({
                path: '/events/findByKeyword/{keyword}',
                operation: 'get'
            }, function (err, mock) {
                var request;
                t.error(err);
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/events/findByKeyword/{keyword}']['get']['responses']['200']['schema']);
