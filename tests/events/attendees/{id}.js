...
/**
 * Test for /events/attendees/{id}
 */
Test('/events/attendees/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test events_getAttendees get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/events/attendees/{id}']['get']['responses']['200']['schema']);
