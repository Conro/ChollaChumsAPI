...
/**
 * Test for /events/findById/{id}
 */
Test('/events/findById/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test events_getById get operation', function (t) {
            Mockgen().requests({
                path: '/events/findById/{id}',
                operation: 'get'
            }, function (err, mock) {
                var request;
                t.error(err);
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/events/findById/{id}']['get']['responses']['200']['schema']);
