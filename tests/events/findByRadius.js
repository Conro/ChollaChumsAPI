...
/**
 * Test for /events/findByRadius
 */
Test('/events/findByRadius', function (t) {
        ...
        t.test('test events_getByUser get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/events/findByRadius']['get']['responses']['200']['schema']);
