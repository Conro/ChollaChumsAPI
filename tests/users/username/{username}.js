...
/**
 * Test for /users/username/{username}
 */
Test('/users/username/{username}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test users_getByUsername get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/users/username/{username}']['get']['responses']['200']['schema']);
